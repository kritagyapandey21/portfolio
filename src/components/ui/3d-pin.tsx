    ...
    >
      ...
      >
        <div
          ...
          className="absolute left-1/2 p-4 top-1/2 flex justify-start items-start rounded-2xl shadow-[0_8px_16px_rgb(0_0_0/0.4)] bg-slate-950 border border-white/[0.1] group-hover/pin:border-indigo-500/[0.4] transition duration-700 overflow-hidden"
        >
    ...
    <motion.div className="pointer-events-none w-96 h-80 flex items-center justify-center opacity-0 group-hover/pin:opacity-100 z-[60] transition duration-500">
      <div className="w-full h-full -mt-7 flex-none inset-0">
        <div className="absolute top-0 inset-x-0 flex justify-center">
          <span
            className="relative flex space-x-2 items-center z-10 rounded-full bg-slate-950 py-0.5 px-4 ring-1 ring-white/10 cursor-pointer"
          >
        ...
        >
          {[0, 2, 4].map((delay) => (
            <motion.div
              ...
              className="absolute left-1/2 top-1/2 h-[11.25rem] w-[11.25rem] rounded-[50%] bg-indigo-500/[0.08] shadow-[0_8px_16px_rgb(0_0_0/0.4)]"
            />
          ))}
        </div>
